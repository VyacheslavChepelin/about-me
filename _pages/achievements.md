...
<div class="swiper mySwiper mt-2 pb-4">
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <img src="{{ '/assets/img/achievements/photo_1.jpg' | relative_url }}" class="d-block w-100 rounded shadow" alt="Дипломы и награды — олимпиады">
      <p class="text-center small text-muted mt-2 mb-0">Дипломы олимпиад</p>
    </div>
    <div class="swiper-slide">
      <img src="{{ '/assets/img/achievements/photo_2.jpg' | relative_url }}" class="d-block w-100 rounded shadow" alt="Награждение — математика и информатика">
      <p class="text-center small text-muted mt-2 mb-0">Награждения</p>
    </div>
    <div class="swiper-slide">
      <img src="{{ '/assets/img/achievements/photo_3.jpg' | relative_url }}" class="d-block w-100 rounded shadow" alt="Олимпиадные результаты">
      <p class="text-center small text-muted mt-2 mb-0">Олимпиадный путь</p>
    </div>
  </div>
...
- Преподаю в ИТМО и в ГБУ ДО «Центр Интеллект»
- Работаю в Центре ИИ и науки о данных СПбГУ
- Сканы дипломов могу прислать по запросу
